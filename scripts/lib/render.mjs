...
export function renderRepoDigest({
  ...
  lines.push("");
  lines.push("> _v0.1: deterministic template, no LLM summary yet (see `docs/ROADMAP.md`)._");
  lines.push("");
  ...
  lines.push("---");
  lines.push(`_Generated by [oss-digest](https://github.com/Bojun-Vvibe/oss-digest) · v0.1 deterministic template._`);
